<?php
   ...
   if (UnconfirmedWithdrawals($conn, $userId, $withdrawal_status) !== false) {
    $UnconfirmedWithdrawals = UnconfirmedWithdrawals($conn, $userId, $withdrawal_status);
    $UnconfirmedWithdrawalsExist = true;
   } else {
       $UnconfirmedWithdrawalsExist = false;
   }    
...
<body>
    ...
    <?php if(isset($_GET['msg'])){?>
        ...
        <nav class="navbar navbar-mobile nav-txt-colored" role="navigation">
            ...
            <div id="desktop-links">
                ...
                <li><a class="menuItem" href="index.php">scarface</a></li>
                    <li><a class="menuItem" href="admin.php">Admin Dashboard</a></li>
                    <li><a class="menuItem" href="confirm-deposits.php">Confirm Deposits</a></li>
                    <li><a class="menuItem" href="confirm-withdrawals.php">Confirm Withdrawals</a></li>
                    <li><a class="menuItem" href="show-all-users.php">All Users</a></li>
  ...
  <section class="compass admin-compass user-compass">
    ...
    <?php if ($UnconfirmedWithdrawalsExist == true) {?> 


    <?php foreach($UnconfirmedWithdrawals as $withdrawal) { ?>
      <a href="confirm-chosen-withdrawal.php?withdrawalId=<?php echo $withdrawal['NoId']; ?>">
        <div class="user">
          <div class="user-details-spread">
            <p>$<?php echo $withdrawal['withdrawalAmt'];?></p>
          </div>
        </div>
      </a>
      <?php } ?>
