        ...
        <section class="desktop-format-inner">
            <section class="pad-account pad-confirm pad-withdraw pad-withdraw-confirm">
                ...
                <div class="page-info-other">
                    <p>Change Wallet Address</Address></p>
                </div>
            </section>
            <section class="content section-deposit section-withdraw section-withdraw-confirm section-change-password">
                <form action="includes/change-address.php" method="POST">
                    <div class="throw-kibble">
                        <input type="text" placeholder="New Wallet Address" class="number-input" name="address"
                            id="manual-input">
                    </div>
            </section>
            <section
                ...
                <div class="wag-wag">
                    <button class="btn wag-roll" type="submit" name="change">Reset Wallet Address</button>
                </div>
            </section>
            </form>
        </section>
